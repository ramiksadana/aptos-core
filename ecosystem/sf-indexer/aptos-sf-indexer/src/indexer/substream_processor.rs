...
/// 
/// Note, this is only called when server starts. This should be enough because it's impossible
/// to change chain ID without restarting the node which also restarts the indexer. 
