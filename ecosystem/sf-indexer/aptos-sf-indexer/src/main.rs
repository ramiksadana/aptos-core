...
use aptos_sf_indexer::substream_processors::{block_output_processor, tokens_processor};
...
impl Processor {
    fn from_string(input_str: &String) -> Self {
        match input_str.as_str() {
            block_output_processor::MODULE => Self::BlockToBlockOutput,
            tokens_processor::MODULE => Self::BlockOutputToToken,
